// Базовые параметры для Swiper
const defaultSwiperConfig = {
  // slidesPerView: "auto",
  snapOnRelease: true,
  freeMode: false,

  loop: true, // Попробуйте отключить loop для теста
...
// Слайдер месяца
const swiperMatches = new Swiper(".swiper-matches", {
  ...defaultSwiperConfig,
...
const swiperLatestResults = new Swiper(".swiper-latest-results", {
  ...defaultSwiperConfig,
  slidesPerView: 1, // базовое значение
  spaceBetween: 16, // отступы между карточками
  centeredSlides: true, // активный слайд будет по центру
...
const scheduleSwiper = new Swiper(".swiper-schedule", {
  ...defaultSwiperConfig,
  slidesPerView: 1, // базовое значение
  spaceBetween: 16, // отступы между карточками
  centeredSlides: true, // активный слайд будет по центру
